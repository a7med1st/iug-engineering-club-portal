    ...
    >
      ...
      >
        <div>
          ...
          <p>
            قراءة مباشرة لبيانات
            الطلاب، الأنشطة،
            التسجيلات والحضور من
            قاعدة البيانات.
          </p>
        </div>
      ...
      >
        ...
        <Metric
          ...
          hint={`${summary.attendedCount} من ${summary.attendanceEligibleCount} مقبول لنشاط بدأ`}
          icon={
            CheckCircle2
          }
        />
