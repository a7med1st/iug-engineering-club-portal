        ...
        partner: partner
          ? {
              ...
              title:
                ...
                (partner.role === "ADMIN" ? "إدارة النادي" : "عضو"),
              department: partner.department?.nameAr ?? null,
              hasAvatar: Boolean(partner.avatarStoredName),
              avatarVersion: partner.avatarUpdatedAt?.getTime() ?? 0,
            }
          : null,
        ...
        <ChatSidebar
          ...
          availableUsers={availableUsers.map((item) => ({
            ...
            title:
              ...
              (item.role === "ADMIN" ? "إدارة النادي" : "عضو"),
